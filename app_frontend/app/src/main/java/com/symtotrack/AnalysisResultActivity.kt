...
class AnalysisResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnBackDashboard = findViewById<MaterialButton>(R.id.btn_back_dashboard)
        ...
        val btnFindDoctor = findViewById<MaterialButton>(R.id.btn_find_doctor)
        btnFindDoctor.setOnClickListener {
            // Route to nearby activity map
        ...
        try {
            ...
            getSharedPreferences("user_prefs", MODE_PRIVATE).edit()
                .putString("last_severity", riskLevel)
                .putInt("active_symptom_count", 1)
                .apply()
